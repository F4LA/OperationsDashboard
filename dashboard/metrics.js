 ...
 *
 * Requires OpsDashEngine (for parseISO — calendar date parsing shared with the
 * engine's own, so a date string is interpreted identically everywhere in the app).
 */
(function (root) {
  "use strict";
